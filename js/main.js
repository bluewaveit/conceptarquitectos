...
const translations = {
  en: {
    ...
    'hero.consultation': 'Request a Consultation',
    'hero.valueprop': 'Modern architecture in the Algarve — designed for comfort, efficiency and long-term value.',
    'hero.pill1': 'Residential', 'hero.pill2': 'Commercial', 'hero.pill3': 'Renovations',
    ...
    'services.subtitle': 'We handle the full process — from concept to approval.',
    ...
    'services.name4': 'Project Licensing',
    'services.desc4': "Full management of architectural licensing and regulatory approval. We navigate Portuguese planning law so your project reaches construction on time.",
    'services.name5': 'Renovations & Extensions',
    'services.desc5': "Thoughtful transformation of existing buildings — from historic renovation to contemporary extension. We maximise value while respecting what is already there.",
    ...
    'stag.licensing': 'Permitting', 'stag.planning': 'Urban Planning', 'stag.compliance': 'Regulatory',
    'stag.reno': 'Historic', 'stag.ext': 'Extensions', 'stag.refurb': 'Refurbishment',
    'testimonials.label': 'Client Voices', 'testimonials.title': 'What Our Clients Say',
    'testimonials.count': '2 verified reviews',
    'testimonials.quote2': '"Concept Arquitectos handled everything — design, licensing, and project management. We never had to worry about the bureaucracy."',
    'testimonials.project2': 'Atlantic Terraces · Portimão, 2024',
    'testimonials.quote3': '"The renovation transformed our 1980s property into something we are truly proud of. On budget, on time."',
    'testimonials.author3': 'Residential Client', 'testimonials.source3': 'Portimão, Algarve',
    'testimonials.project3': 'Algarve Residence · Portimão, 2025',
    'faq.label': 'Common Questions', 'faq.title': 'FAQ',
    'faq.q1': 'How long does a typical project take, from first meeting to completion?',
    'faq.a1': 'It depends on the scope. A residential renovation typically takes 6–12 months; a new villa from concept to move-in is usually 18–30 months, including licensing. We give you a clear timeline at the first consultation.',
    'faq.q2': 'Do you manage architectural licensing and planning approvals in Portugal?',
    'faq.a2': 'Yes — this is one of our core services. We handle all submissions to the Câmara Municipal, including project licensing (licença de obras), technical reports, and coordination with planning authorities. Our team knows Algarve planning regulations in detail.',
    'faq.q3': 'Do you work outside the Algarve?',
    'faq.a3': 'Our primary focus is the Algarve region, where we have deep knowledge of local planning rules and construction standards. We do take selected projects in the wider Alentejo and Lisbon areas — contact us to discuss your project.',
    'faq.q4': 'What do I need to bring to a first consultation?',
    'faq.a4': 'Just your ideas and any references or sketches you have. If you already have a plot or property, its details (location, area, existing plans if available) are useful. We do the technical work — you just need to bring your vision.',
    'faq.q5': 'Do you offer consultancy for projects already in progress?',
    'faq.a5': 'Yes. If your project is already underway and you need a second opinion, technical review, or help with licensing, we offer consultancy sessions. Contact us to arrange a call.',
    ...
    'footer.copy': '© 2025 Concept Arquitectos · Portimão, Portugal',
  ...
  pt: {
    ...
    'hero.consultation': 'Solicitar Consulta',
    'hero.valueprop': 'Arquitetura moderna no Algarve — concebida para conforto, eficiência e valor a longo prazo.',
    'hero.pill1': 'Residencial', 'hero.pill2': 'Comercial', 'hero.pill3': 'Remodelações',
    'hero.country': 'Portugal',
    ...
    'services.subtitle': 'Gerimos todo o processo — do conceito à aprovação.',
    ...
    'services.name4': 'Licenciamento',
    'services.desc4': 'Gestão completa de licenciamento arquitetónico e aprovações regulatórias. Navegamos a legislação de planeamento português para que o seu projeto avance dentro dos prazos.',
    'services.name5': 'Remodelações e Ampliações',
    'services.desc5': 'Transformação cuidadosa de edifícios existentes — da reabilitação histórica à ampliação contemporânea. Maximizamos o valor respeitando o que já existe.',
    ...
    'stag.licensing': 'Licenciamento', 'stag.planning': 'Planeamento Urbano', 'stag.compliance': 'Regulatório',
    'stag.reno': 'Histórico', 'stag.ext': 'Ampliações', 'stag.refurb': 'Reabilitação',
    'testimonials.label': 'Vozes dos Clientes', 'testimonials.title': 'O que dizem os nossos clientes',
    'testimonials.count': '2 avaliações verificadas',
    'testimonials.quote2': '"A Concept Arquitectos tratou de tudo — projeto, licenciamento e gestão de obra. Nunca tivemos de nos preocupar com a burocracia."',
    'testimonials.project2': 'Atlantic Terraces · Portimão, 2024',
    'testimonials.quote3': '"A renovação transformou a nossa moradia dos anos 80 em algo de que nos orgulhamos verdadeiramente. Dentro do orçamento e dentro dos prazos."',
    'testimonials.author3': 'Cliente Residencial', 'testimonials.source3': 'Portimão, Algarve',
    'testimonials.project3': 'Residência Algarve · Portimão, 2025',
    'faq.label': 'Perguntas Frequentes', 'faq.title': 'FAQ',
    'faq.q1': 'Quanto tempo demora um projeto típico, desde a primeira reunião até à conclusão?',
    'faq.a1': 'Depende da dimensão da obra. Uma remodelação residencial demora geralmente 6 a 12 meses; uma moradia nova do conceito à mudança é habitualmente 18 a 30 meses, incluindo licenciamento. Apresentamos um cronograma claro na primeira consulta.',
    'faq.q2': 'Tratam do licenciamento arquitetónico e das aprovações em Portugal?',
    'faq.a2': 'Sim — é um dos nossos serviços principais. Tratamos de todas as submissões à Câmara Municipal, incluindo a licença de obras, memórias descritivas e coordenação com as entidades. A equipa conhece em detalhe o planeamento urbano do Algarve.',
    'faq.q3': 'Trabalham fora do Algarve?',
    'faq.a3': 'O nosso foco principal é a região do Algarve, onde temos profundo conhecimento das regras de planeamento local. Aceitamos projetos selecionados no Alentejo e na área de Lisboa — contacte-nos para discutir o seu projeto.',
    'faq.q4': 'O que devo levar para uma primeira consulta?',
    'faq.a4': 'Apenas as suas ideias e referências ou esboços que tenha. Se já tiver um terreno ou imóvel, os seus dados (localização, área, plantas existentes se as tiver) são úteis. Tratamos da parte técnica — só precisa de trazer a sua visão.',
    'faq.q5': 'Oferecem consultoria para projetos já em curso?',
    'faq.a5': 'Sim. Se o seu projeto já está em desenvolvimento e precisa de uma segunda opinião, revisão técnica ou apoio no licenciamento, oferecemos sessões de consultoria. Contacte-nos para agendar uma chamada.',
